      ...
      const n = { match: /\s+/, relevance: 0 },
        ...
        o = {
          variants: [{
            className: "keyword",
            match: m(
              ...Ae.filter((e) => "string" != typeof e).concat(Me).map(ke),
              ...Oe,
            ),
          }],
        },
...
"object" == typeof exports && "undefined" != typeof module &&
  (module.exports =
    hljs); /*! `ocaml` grammar compiled for Highlight.js 11.10.0 */
(() => {
  var e = (() => {
    "use strict";
    return (e) => ({
...
(function () {
  if (typeof hljs !== "undefined") {
    var d = hljs.getLanguage("lisp");
    if (d) {
      hljs.registerLanguage("dune", function () {
        return d;
      });
    }
  }
