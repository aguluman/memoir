...
return Ke}()
;"object"==typeof exports&&"undefined"!=typeof module&&(module.exports=hljs);/*! `ocaml` grammar compiled for Highlight.js 11.10.0 */
...
relevance:0},{begin:/->/}]})})();hljs.registerLanguage("ocaml",e)})();/*! `dockerfile` grammar compiled for Highlight.js 11.10.0 */
...
;hljs.registerLanguage("dockerfile",e)})();/*! `lisp` grammar compiled for Highlight.js 11.10.0 */
...
})();;(function(){if(typeof hljs!=="undefined"){var d=hljs.getLanguage("lisp");if(d)hljs.registerLanguage("dune",function(){return d});}}());
